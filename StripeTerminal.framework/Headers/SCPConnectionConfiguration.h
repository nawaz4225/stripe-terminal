...
/**
 Base class for BluetoothReaderConnectionConfiguration and
 InternetReaderConnectionConfiguration.
...
/**
 ...
 Use BluetoothReaderConnectionConfiguration or
 InternetReaderConnectionConfiguration depending on the reader
