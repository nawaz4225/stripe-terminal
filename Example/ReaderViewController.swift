...
class ReaderViewController: TableViewController, TerminalDelegate, CancelingViewController, BluetoothReaderDelegate {
    ...
    private func showDiscoverReaders() {
        let config: DiscoveryConfiguration = DiscoveryConfiguration(
